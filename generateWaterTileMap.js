...
export const WATER_BORDER_INSIDE_TOP_LEFT = 435;
export const WATER_BORDER_INSIDE_TOP_RIGHT = 433;
export const WATER_BORDER_INSIDE_BOTTOM_LEFT = 387;
export const WATER_BORDER_INSIDE_BOTTOM_RIGHT = 385;
